/**
 * Space Topology & Adjacency Graph Engine (Frontend ES Module)
...
export const ENTRY_TYPES = ['Living Room', 'Hall', 'Foyer'];
export const PRIVATE_TYPES = ['Bedroom', 'Master Bedroom', 'Study Room', 'Bathroom', 'Washroom'];
export const BED_TYPES = ['Bedroom', 'Master Bedroom', 'Study Room'];
export const BATH_TYPES = ['Bathroom', 'Washroom'];
...
export function buildAdjacencyGraph(instances, floorLevel) {
  const nodes = [];
  const edges = [];
